  ...
  return (
    <>
      <div className="min-h-screen bg-[#09090b] text-white overflow-x-hidden">
        ...
        {/* ───────── HERO SPLIT ───────── */}
        <section className="blog-hero-section relative w-full pt-32 pb-24 overflow-hidden">
          ...
          <div className="container mx-auto px-6 max-w-7xl">
            <div className="blog-hero-grid grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="flex flex-col items-start">
                ...
                <div className="blog-hero-ctas flex flex-row gap-4 flex-wrap mt-2">
              ...
              {/* RIGHT — Image */}
              <div className="blog-hero-image relative w-full h-[400px] md:h-[500px] lg:h-[580px] rounded-[2rem] overflow-hidden border border-white/5 shadow-2xl group">
        ...
        <section id="posts" className="blog-posts-section relative w-full py-28 overflow-hidden">
          ...
          <div className="container mx-auto px-6 max-w-7xl">
            <div className="blog-posts-header text-center mb-16">
              <div className="blog-posts-badge flex items-center justify-center gap-2 px-3 py-1.5 rounded-full border border-white/10 bg-white/[0.03] w-fit mx-auto mb-5">
                <span className="text-white/60 text-xs font-semibold tracking-wide">Latest Articles</span>
              </div>
              <h2 className="blog-posts-title text-3xl md:text-4xl lg:text-[48px] font-semibold text-white tracking-tight leading-tight">
            ...
            {/* Post Grid */}
            <div className="blog-posts-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {BLOG_POSTS.map((post) => (
                <Link
                  key={post.slug}
                  to={`/blog/${post.slug}`}
                  className="blog-post-card group relative rounded-[1.5rem] bg-[#111116]/60 backdrop-blur-md border border-white/5 p-8 flex flex-col gap-5 hover:-translate-y-1 hover:border-white/10 transition-all duration-300 overflow-hidden"
                >
                  {/* Top edge hover glow */}
        ...
        {/* ───────── 2nd COUNTER (Numbers That Matter) ───────── */}
          <div className="blog-stats-section mt-24 mb-16">
            <div className="blog-stats-header flex items-center gap-3 mb-8">
               <div className="h-px flex-1 bg-white/10"></div>
               <h2 className="blog-stats-title text-2xl font-semibold text-white tracking-tight px-4">The Numbers That Matter</h2>
               <div className="h-px flex-1 bg-white/10"></div>
            </div>
        ...
        <section className="blog-cta-section w-full py-20">
          <div className="container mx-auto px-6 max-w-3xl text-center">
            <h2 className="blog-cta-title text-2xl md:text-3xl font-semibold text-white mb-4 tracking-tight">
